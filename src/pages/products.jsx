    ...
    return (
        <div className="flex justify-center py-5">
            <CardProduct>
                ...
                <CardProduct.Body title="Bicycle v.1">
            ...
            <CardProduct>
                <CardProduct.Header image="./images/bycle-1.jpg" />
                <CardProduct.Body title="Bicycle v.2">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Perferendis adipisci nostrum recusandae veritatis voluptate
                    eaque unde sunt reiciendis quas accusamus tempore.
                </CardProduct.Body>
